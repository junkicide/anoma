...
impl StoredKeypair {
    ...
    pub fn get(&self, decrypt: bool) -> Result<Rc<ed25519c::Keypair>, DecryptionError> {
        match self {
...
impl EncryptedKeypair {
    ...
    pub fn new(keypair: &ed25519c::Keypair, password: String) -> Self {
    ...
    pub fn decrypt(
        &self,
        password: String,
    ) -> Result<ed25519c::Keypair, DecryptionError> {
        ...
        ed25519c::Keypair::try_from_slice(&decrypted_data)
